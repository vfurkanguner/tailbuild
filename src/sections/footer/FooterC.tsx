        ...
        <div className="col-span-2 order-first">
          ...
          <form className="mt-4">
            <div className="flex space-x-2">
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-blue-600 dark:bg-blue-600 text-white rounded-md hover:bg-blue-700 dark:hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 dark:focus:ring-blue-400"
              >
                Subscribe
              </button>
            </div>
