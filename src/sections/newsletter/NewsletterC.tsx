...
export default function NewsletterC({}: Props) {
  return (
    <div className="bg-slate-900 text-slate-100 px-4 py-16">
        ...
        <div className="mt-4">
          <form className="flex space-x-4 max-2xl">
            <div className="py-1 w-full flex flex-col md:flex-row gap-4">
              <input
                type="text"
                className="px-8 py-3 rounded-lg   placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
