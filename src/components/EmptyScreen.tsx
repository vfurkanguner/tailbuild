...
export default function EmptyScreen({ }: Props) {
  return (
    <div>
      <div className="absolute  w-full h-full from-slate-900 overflow-hidden to-indigo-900 bg-gradient-to-t  text-white py-16 px-16 flex flex-col text-center gap-4 items-center justify-center">
